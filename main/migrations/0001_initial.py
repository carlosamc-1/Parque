# Generated by Django 4.0.3 on 2022-04-25 16:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clienteid', models.ForeignKey(db_column='ClienteID', on_delete=django.db.models.deletion.CASCADE, to='main.cliente')),
            ],
        ),
        migrations.CreateModel(
            name='Dia',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parqueid', models.ForeignKey(db_column='ParqueID', default=1, on_delete=django.db.models.deletion.CASCADE, to='main.parque')),
            ],
        ),
        migrations.CreateModel(
            name='Zona',
            fields=[
                ...
                ('parqueid', models.ForeignKey(db_column='ParqueID', on_delete=django.db.models.deletion.CASCADE, to='main.parque')),
            ],
        ),
        migrations.CreateModel(
            name='Viatura',
            fields=[
                ...
                ('contratoid', models.ForeignKey(db_column='ContratoID', on_delete=django.db.models.deletion.CASCADE, to='main.contrato')),
                ('registo_movimentoid', models.ForeignKey(db_column='Registo-movimentoID', on_delete=django.db.models.deletion.CASCADE, to='main.registomovimento')),
            ],
        ),
        migrations.CreateModel(
            name='TabelaPrecos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_de_termino', models.DateTimeField(blank=True, db_column='Data de termino', null=True)),
                ('parqueid', models.ForeignKey(db_column='ParqueID', default=1, on_delete=django.db.models.deletion.CASCADE, to='main.parque')),
                ('viaturaid', models.ForeignKey(db_column='ViaturaID', default=1, on_delete=django.db.models.deletion.CASCADE, to='main.viatura')),
            ],
        ),
        migrations.CreateModel(
            name='Pagamento',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contratoid', models.ForeignKey(db_column='ContratoID', on_delete=django.db.models.deletion.CASCADE, to='main.contrato')),
                ('reservaid', models.ForeignKey(db_column='ReservaID', on_delete=django.db.models.deletion.CASCADE, to='main.reserva')),
                ('viaturaid', models.ForeignKey(db_column='ViaturaID', on_delete=django.db.models.deletion.CASCADE, to='main.viatura')),
                ('zonaid', models.ForeignKey(db_column='ZonaID', on_delete=django.db.models.deletion.CASCADE, to='main.zona')),
            ],
        ),
        migrations.CreateModel(
            name='Funcionario',
        ...
        migrations.AddField(
            model_name='contrato',
            name='parqueid',
            field=models.ForeignKey(db_column='ParqueID', default=1, on_delete=django.db.models.deletion.CASCADE, to='main.parque'),
        ),
        migrations.CreateModel(
            name='Administrador',
            fields=[
